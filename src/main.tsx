...
import type { GenDate, FmtDate, FlashState, ModeProps, DedOpts } from './modes/modeTypes.js'
...
// AoxBest / BlitzBest / SuddenBest moved to store/progress.ts (the persisted store owns them); imported above.
    ...
    const yearGridLayout=(n: number)=>({gridCls:n===2?"grid-cols-2":n===5?"grid-cols-6":"grid-cols-3",colSpanFor:(idx: number)=>n===5?(idx<3?"col-span-2":"col-span-3"):""});
